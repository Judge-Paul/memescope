		...
		<div className="mt-2">
			<div className="flex justify-between">
				<div className="flex items-center gap-2">
					...
					<h1 className="font-bold text-xl">MemeScope</h1>
				</div>
				<Button
					variant="outline"
					className={cn(
						"rounded-full hover:bg-background border-2 border-accent-purple px-8",
						"transition-all duration-300 ease-in-out hover:border-2 hover:border-accent-purple hover:-translate-y-1 active:scale-90",
					)}
				>
					<FaWallet />
					Connect
			...
			<div className="mt-4 flex flex-wrap lg:flex-nowrap gap-4 items-center justify-between">
